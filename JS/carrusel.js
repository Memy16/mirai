// carrusel.js
function crearCarrusel(selector) {
  ...
  function goNext() {
    ...
    if (total <= visible) return;                 // nada que deslizar
    index = (index < total - visible) ? index + 1 : 0;  // loop
    update();
  }
...
crearCarrusel('#carrusel-eventos');
crearCarrusel('#carrusel-salidas');